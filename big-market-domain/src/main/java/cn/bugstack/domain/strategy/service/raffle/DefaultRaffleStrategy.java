...
import cn.bugstack.domain.strategy.service.rule.chain.impl.DefalutLogicChain;
...
@Slf4j
@Service
public class DefaultRaffleStrategy extends AbstractRaffleStrategy implements IRaffleStrategy, IRaffleStock {
